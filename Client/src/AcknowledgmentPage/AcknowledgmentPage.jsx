		...
		<div className={styles.container}>
			...
			<div className={styles.messageBox}>
				<p className={`${styles.message} ${styles.animateMessage}`}>
					...
					engage and motivate students, coupled with your unwavering support and
					expertise, sets a remarkable example for us all. You embody the
					qualities of outstanding educators and have become role models for our
					team. We are deeply grateful for the positive impact you have had on
					our learning journey and for the high standards you uphold. Thank you
					for being such exemplary mentors.
				</p>
			</div>
		</div>
	);
